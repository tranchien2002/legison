...
4. Thủ trưởng cơ quan giải quyết bồi thường quyết định mức tạm ứng cho người yêu cầu bồi thường nhưng không dưới 50% giảiiá trị các thiệt hại quy định tại khoản 1 Điều này.
...
Mục 2
GIẢI QUYẾT VỤ ÁN DÂN SỰ VỀ YÊU CẦU BỒI THƯỜNG,
...
Nguyễn Thị Kim Ngân"
# a = /ký\)(\s)+(((\p{Lu}\p{Ll}+)\s*)+(\p{Lu}\p{Ll}+)?)/.match(string)
# p a[2]
chapters = []
